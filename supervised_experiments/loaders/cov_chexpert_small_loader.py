...
class CovidChexpertDatasetGenerator(Dataset):
    ...
    def load_covid_images(self, split):
        covid_pathDirData = "/data8/rajiv_porana/covid_dataset/covidx3_upsampled/"
        #covid_lugsegdir = "/data/mariammaa/dataset/covidx3_upsampled_lung_segment/"
        if split == "train":
            pathDatasetFile = "/data8/rajiv_porana/covid_dataset/covid_train.txt"
            pathImageDirectory = os.path.join(covid_pathDirData,"train") 
        elif split == "val":
            pathDatasetFile = "/data8/rajiv_porana/covid_dataset/covid_val.txt"
            pathImageDirectory = os.path.join(covid_pathDirData,"test")
        elif split == "test":    
            pathDatasetFile = "/data8/rajiv_porana/covid_dataset/covid_test.txt"
            pathImageDirectory = "/data8/rajiv_porana/covid_dataset/covid_binary_test/"
            pathWaImageDirectory = "/data8/rajiv_porana/covid_dataset/covid_binary_test_whatsapp_CORRECT/"
