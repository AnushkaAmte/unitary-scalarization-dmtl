...
def main():
    ...
    parser.add_argument('--model_folder', type=str, default='/data6/anushkapa_scratch/unitary-scalarization-dmtl/vindr/saved_models/', help='model folder')
...
#python3 vindr_ols.py --net_basename vindr_obj_det_5 --model_name best --tasks 